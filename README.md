<!-- Header Banner -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=7dd3fc&height=200&section=header&text=Ratnakanthan&fontSize=60&fontColor=0d1117&animation=twinkling&desc=PHP%20Full%20Stack%20Engineer&descAlignY=70&descSize=22" width="100%" />

<!-- Typing SVG -->
<div align="center">

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&pause=1000&color=7DD3FC&center=true&vCenter=true&width=700&lines=PHP+7.4+%2F+8%2B+%E2%80%A2+Laravel+%E2%80%A2+Magento+2+%E2%80%A2+Zend;RESTful+APIs+%E2%80%A2+GraphQL+%E2%80%A2+OAuth+2.0+%2F+JWT;MySQL+optimisation+%E2%80%A2+PostgreSQL+%E2%80%A2+Docker+%E2%80%A2+AWS;Building+AnyVacancy+%E2%80%94+instant+UK+shift-worker+matching;SOLID+%E2%80%A2+OWASP+secure+coding+%E2%80%A2+CI%2FCD+%E2%80%A2+Scrum)](https://git.io/typing-svg)
...
const ratnakanth = {
  ...
  stack: {
    ...
    frameworks:  ["Laravel", "Zend Framework", "Magento 2", "jQuery"],
    apis:        ["RESTful APIs", "GraphQL", "OAuth 2.0 / JWT", "Third-Party Integration", "Microservices"],
    databases:   ["MySQL (query optimisation, indexing, tuning)", "PostgreSQL", "SQLite", "NoSQL awareness"],
    quality:     ["Unit testing", "Automated testing", "Code review", "SOLID", "OWASP secure coding"],
    devops:      ["Git (GitHub/GitLab workflows)", "Docker (WSL/Linux)", "CI/CD pipelines", "AWS"],
    cms:         ["Magento 2", "WordPress", "Zend Framework"],
  ...
  certifications: [],
  status: "Building and scaling AnyVacancy",
...
[![Frontend](https://skillicons.dev/icons?i=jquery,html,css,js,ts&theme=dark)](https://skillicons.dev)

**Backend & Infra**

[![Backend](https://skillicons.dev/icons?i=laravel,php,wordpress,docker,linux&theme=dark)](https://skillicons.dev)
...
[![Databases](https://skillicons.dev/icons?i=mysql,postgres,sqlite,graphql&theme=dark)](https://skillicons.dev)
